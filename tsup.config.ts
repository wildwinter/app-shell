...
export default defineConfig({
  ...
  dts: { entry: ["src/index.ts", "src/menu.ts", "src/tool-window.ts", "src/job.ts", "src/vc-status.ts", "src/app-store.ts", "src/updater.ts", "src/session.ts", "src/dialog.ts", "src/floating.ts", "src/context-menu.ts"] },
  clean: true,
  sourcemap: true,
  treeshake: true,
