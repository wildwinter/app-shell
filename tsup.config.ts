...
export default defineConfig({
  entry: [
    "src/index.ts", "src/menu.ts", "src/tool-window.ts", "src/job.ts", "src/vc-status.ts", "src/app-store.ts", "src/updater.ts",
  ...
  dts: { entry: ["src/index.ts", "src/menu.ts", "src/tool-window.ts", "src/job.ts", "src/vc-status.ts", "src/app-store.ts", "src/updater.ts"] },
  clean: true,
  sourcemap: true,
  treeshake: true,
